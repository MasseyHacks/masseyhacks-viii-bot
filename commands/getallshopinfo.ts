                    ...
                    collector.on('collect', async i => {
                        ...
                        try{
                            if(i.customId == "forward" || i.customId == "backward"){
                                    ...
                                    embeds : [
                                        {
                                            ...
                                            description: `Are you sure you want to delete ${shopItems[pagination].name}? Note that this action is **irreversible**.`,
                                            color: "RED"
                                        }
                                    ],
                                    components:[deleteActionRow]
                                ...
                                await shops.findOneAndDelete({_id: shopItems[pagination]._id});
                                await i.editReply({
                                    embeds: [
                                        {
                                            title: "Item Deleted",
                                            description: `Alright, ${shopItems[pagination].name} has been deleted!`, 
                                            color: "GREEN"
                                        }
                                    ],
                                    components: []
                                ...
                                await i.editReply({
                                    embeds: [
                                        {
                                            title: "Action Cancelled",
                                            description: `Alright, ${shopItems[pagination].name} has not been deleted!`, 
                                            color: "GREEN"
                                        }
                                    ],
                                    components: []
